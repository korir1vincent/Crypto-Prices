...
//       setCoin(data);
//     } catch (err) {
//       console.log("Error fetching cryptos:", err);
//     } finally {
//       setIsLoading(false);
//     }
//   };
...
//     try {
//       const data = await fetchChartData(id);
//       const formarttedData = data.prices.map((price) => ({
...
//           <div className="logo-section">
//             <h1>🚀 Crypto Tracker</h1>
//             <p>Real-time crypto prices and market data</p>
//           </div>
//           <button onClick={() => navigate("/")} className="back-button">
//             {" "}
//             ⬅ Back to the list
